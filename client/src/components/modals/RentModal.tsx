...
//import CountrySelect from '../inputs/HostelSelect';
...
import HostelSelect from '../inputs/HostelSelect';
...
const RentModal:React.FC = () => {
  ...
  <div className='flex flex-col gap-8'>
    <Heading title='Whicj of these best describes your item'
  ...
  if (step === STEPS.LOCATION) {
    bodyContent = (
      <div className="flex flex-col gap-8">
        <Heading
          title="Which hostel are you staying in?"
          subtitle="Help people find you"
        />
        <HostelSelect
          value={location}
  ...
  if (step === STEPS.IMAGES) {
    bodyContent = (
      <div className="flex flex-col gap-8">
        ...
        <BiImageAlt
          className="text-6xl text-gray-500 cursor-pointer hover:text-gray-700 transition-transform transform hover:scale-110"
